    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 to-secondary/5">
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        <motion.div
          ...
          className="flex justify-center gap-3 sm:gap-8 mb-4 sm:mb-8 text-xs sm:text-sm"
        >
          <div className="flex items-center gap-1.5 sm:gap-2">
            <Users className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-muted-foreground" />
            <span className="text-muted-foreground">
              <span className="hidden sm:inline">{profiles.length - currentIndex} profiles remaining</span>
              <span className="sm:hidden">{profiles.length - currentIndex} left</span>
            </span>
          </div>
          <div className="flex items-center gap-1.5 sm:gap-2">
            <Heart className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-rose-500" />
            <span className="text-muted-foreground">
              <span className="hidden sm:inline">Viewing profile {currentIndex + 1}</span>
